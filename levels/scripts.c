...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_STARSTONE,      starstone_geo),
    LOAD_MODEL_FROM_GEO(MODEL_DRUM,      drum_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PIANO,      piano_geo),
    LOAD_MODEL_FROM_GEO(MODEL_VIOLONCELLO,      violoncello_geo),
    LOAD_MODEL_FROM_GEO(MODEL_VIOLIN,      violin_geo),
    LOAD_MODEL_FROM_GEO(MODEL_VIOLA,      viola_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CONTRABASS,      contrabass_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ELEC_GUITAR,      elec_guitar_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TRUMPET,      trumpet_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TROMBONE,      trombone_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ALTO_SAX,      alto_sax_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TENOR_SAX,      tenor_sax_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BASS_GUITAR,      bass_guitar_geo),
