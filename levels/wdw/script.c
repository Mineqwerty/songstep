...
const LevelScript level_wdw_entry[] = {
	...
	AREA(1, wdw_area_1),
		...
		OBJECT(MODEL_NONE, 1, 102, 1936, 0, 0, 0, 0x00010000, bhvCreditsCheckpoint),
		OBJECT(MODEL_NONE, 1, 102, 4589, 0, 0, 0, 0x00020000, bhvCreditsCheckpoint),
		OBJECT(MODEL_NONE, 1, 102, 7115, 0, 0, 0, 0x00030000, bhvCreditsCheckpoint),
		OBJECT(MODEL_NONE, 1, 102, 10338, 0, 0, 0, 0x00040000, bhvCreditsCheckpoint),
		OBJECT(MODEL_NONE, 1, 102, 987, 0, 0, 0, 0x00000000, bhvCreditsCheckpoint),
		OBJECT(MODEL_NONE, 1, 102, 12013, 0, 0, 0, 0x00050000, bhvCreditsCheckpoint),
		OBJECT(MODEL_COWQUACK, -529, 101, 2420, 0, -90, 0, 0x00000000, bhvCreditsNPC),
		OBJECT(MODEL_TORI, -682, 106, 5345, 0, -90, 0, 0x00010000, bhvCreditsNPC),
		MARIO_POS(0x01, 0, 0, 0, 0),
		OBJECT(MODEL_NONE, 0, 98, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
