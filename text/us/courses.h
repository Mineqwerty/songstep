...
COURSE_ACTS(COURSE_WF, _(" 1 MEZZO FORTE MEADOW"),
       _("COLLECT INSTRUMENTS")        , _("TO THE TOP OF THE FORTRESS")    , _("SHOOT INTO THE WILD BLUE"),
...
COURSE_ACTS(COURSE_CCM, _(" 2 C-MAJOR CITY"),
       _("COLLECT INSTRUMENTS")             , _("LI'L PENGUIN LOST")             , _("BIG PENGUIN RACE"),
